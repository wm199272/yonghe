...
<body>
	...
	<form action="orderUpdate" method="POST">
		...
		<table border="1">
			<tr>
				<td width="30%">所属门店</td>
				<td><select id="doorId" name="doorId" data="${ order.doorId }">
			...
			<tr>
				<td>支付金额</td>
				<td><input type="text" name="price" value="${ order.price }" />
				</td>
			</tr>
			<tr>
